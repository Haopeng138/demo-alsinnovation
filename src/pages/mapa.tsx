...
export default function MapaDashboard() {
  ...
  const handleZoneClick = (zone) => {
    setSelectedZone(selectedZone && selectedZone.id === zone.id ? null : zone);
  };
    ...
    <div className="bg-white p-6 rounded-lg">
      ...
      <header className="flex justify-between items-center mb-6 pb-4 border-b">
        <div className="flex items-center">
          <div className="mr-2 text-3xl font-bold tracking-tighter">
            <span className="text-gray-900">ALS</span>
          </div>
        </div>
        ...
        <div className="lg:w-2/3 bg-white border rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="p-4 relative" style={{ height: '500px' }}>
            ...
            <svg viewBox="0 0 600 500" className="w-full h-full">
              ...
              <rect x="0" y="0" width="600" height="500" fill="#F8F9FA" />
            ...
            <div className="absolute top-4 right-4 bg-white p-3 rounded-lg shadow-md border border-gray-200">
              ...
              {zonasData.map((zona) => (
                <div key={zona.id} className="flex items-center mb-1 text-sm">
                  <div
            ...
            <div className="bg-white border rounded-lg shadow-sm p-6">
              ...
              <div className="my-6 border-b pb-6">
                <div className="flex items-baseline">
                  ...
                  <span className="ml-2 text-gray-600">visitantes</span>
                  <span className="ml-1 text-sm text-gray-500">ahora</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div className="flex justify-between w-full">
                    <span className="text-gray-600">Pico de visitantes:</span>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex justify-between w-full">
                    <span className="text-gray-600">Tiempo de estancia:</span>
                    <span className="font-semibold">
                ...
                <div className="flex items-center">
                  <ArrowRight size={18} className="text-gray-400 mr-2" />
                  <div className="flex justify-between w-full">
                    <span className="text-gray-600">Flujo de entrada:</span>
                    <span className="font-semibold">
              ...
              <div className="space-y-4">
                {zonasData.map((zona) => (
                  ...
                  >
                    ...
                    >
                      <span className="text-white font-bold">{zona.id}</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-medium">{zona.name}</h3>
                      <div className="flex justify-between mt-1">
                        <span className="text-sm text-gray-500">
                          {zona.visitors.toLocaleString()} visitantes
                        </span>
                        <span
                        ...
                        >
                          {Math.round((zona.visitors / zona.peak) * 100)}%
                          ocupación
                        </span>
                      </div>
                    </div>
            ...
            >
              <div className="flex items-center mb-2">
                <div
                  ...
                  style={{ backgroundColor: zona.color }}
                ></div>
                <h3 className="font-medium">Zona {zona.id}</h3>
              </div>
              <div className="flex items-baseline">
              ...
              <div className="mt-2 text-sm text-gray-600">
                Pico: {zona.peak.toLocaleString()} | {zona.dwellTime} min |{' '}
                {zona.entering}/h
              </div>
            </div>
          ))}
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {zonasData.map((zona) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        {zona.visitors.toLocaleString()} personas
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        {zona.peak.toLocaleString()} personas
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        {zona.dwellTime} minutos
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        {zona.entering} personas/hora
                      </td>
                    </tr>
                  ))}
                </tbody>
      ...
      <div className="mt-10 flex justify-center">
        <div className="flex items-center">
          <svg viewBox="0 0 500 120" width="160" height="48" className="mr-3">
            <g fill="#0F2B46">
              {/* A */}
          ...
          <div>
            ...
            <div className="text-lg font-medium text-gray-700">Innovation</div>
          </div>
        </div>
      </div>
