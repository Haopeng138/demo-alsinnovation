        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <div className="flex space-x-3">
              ...
              />
              <SelectDropdown
                options={['Global', 'Americas', 'Europe', 'Asia']}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  >
                    ...
                    <Tooltip
                      formatter={(value, name) =>
                        name === 'probability'
                          ? [`${(value * 100).toFixed(0)}%`, 'Probabilidad']
                          : [`${value}/100`, 'Impacto']
                      }
                    />
                    <Legend />
            ...
            <div className="bg-white rounded-lg shadow-sm p-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg mt-4 text-xs">
                <span className="font-medium">Recomendación:</span> La zona
                óptima para operaciones es 20-24°C con eficiencia s95% y costos
                mínimos.
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
            ...
            <div className="mt-4 bg-green-50 p-3 rounded-lg text-xs text-green-700">
              <span className="font-medium">Oportunidad:</span> Potencial para
              reducir emisiones en un 16% y costos energéticos en un 12% durante
              los próximos 6 meses mediante ajustes basados en pronósticos
              climáticos.
            </div>
          </div>
        </div>
