...
const medioSeleccionadoData = {
    ...
    analisis: {
        ...
        evolucionTemporal: [
            { hora: '06:00', politica: 30, economia: 40, deportes: 10, internacional: 15, sociedad: 5 },
            { hora: '07:00', politica: 35, economia: 35, deportes: 15, internacional: 10, sociedad: 5 },
            { hora: '08:00', politica: 45, economia: 25, deportes: 20, internacional: 5, sociedad: 5 },
            { hora: '09:00', politica: 40, economia: 20, deportes: 25, internacional: 5, sociedad: 10 },
            { hora: '10:00', politica: 35, economia: 30, deportes: 20, internacional: 5, sociedad: 10 },
            { hora: '11:00', politica: 30, economia: 30, deportes: 25, internacional: 5, sociedad: 10 },
        ],
        sentimiento: [
        ...
        comparativaCompetencia: [
            { medio: 'RAC1', politica: 45, economia: 25, deportes: 20, internacional: 5, sociedad: 5 },
            { medio: 'SER', politica: 40, economia: 30, deportes: 10, internacional: 15, sociedad: 5 },
            { medio: 'COPE', politica: 30, economia: 20, deportes: 40, internacional: 5, sociedad: 5 },
            { medio: 'Catalunya Ràdio', politica: 35, economia: 25, deportes: 15, internacional: 20, sociedad: 5 },
            { medio: 'Onda Cero', politica: 40, economia: 30, deportes: 15, internacional: 5, sociedad: 10 },
        ],
        palabrasClave: [
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                            <div className="flex items-center mb-4 md:mb-0">
                                <h2 className="text-xl font-bold text-gray-800 mr-4">
                                    Observatorio Competitivo de Contenidos en Tiempo Real
                                </h2>
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex items-center text-sm text-gray-500">
                                    ...
                                    <span>Hora: {selectedMedio.transcripcion.hora}</span>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                                ...
                                <div className="h-72">
                                    ...
                                    >
                                        <PieChart>
                                            <Pie
                                                data={selectedMedio.analisis.distribucionTemas}
                                                cx="50%"
                                                cy="50%"
                                                labelLine={false}
                                                outerRadius={80}
                                            ...
                                            >
                                                {selectedMedio.analisis.distribucionTemas.map((entry, index) => (
                                ...
                                <div className="mt-2 flex items-center justify-center">
                                    <span className="text-xs text-gray-600">
                                        Análisis basado en transcripción completa del programa
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                                ...
                                <div className="h-72">
                                    ...
                                    >
                                        <BarChart
                                            data={selectedMedio.analisis.evolucionTemporal}
                                            margin={{
                                                top: 5,
                                                right: 30,
                                                left: 20,
                                        ...
                                        >
                                            ...
                                            <Tooltip />
                                            <Legend />
                                            <Bar dataKey="politica" name="Política" fill="#0088FE" stackId="a" />
                                            <Bar dataKey="economia" name="Economía" fill="#00C49F" stackId="a" />
                                            <Bar dataKey="deportes" name="Deportes" fill="#FFBB28" stackId="a" />
                                            <Bar dataKey="internacional" name="Internacional" fill="#FF8042" stackId="a" />
                                            <Bar dataKey="sociedad" name="Sociedad" fill="#8884d8" stackId="a" />
                                        </BarChart>
                                    </ResponsiveContainer>
                                </div>
                                <div className="mt-2 flex items-center justify-center">
                                    <span className="text-xs text-gray-600">
                                        Evolución temática desde el inicio del programa (06:00)
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                                ...
                                <div className="h-64">
                                    ...
                                    >
                                        <BarChart
                                            data={selectedMedio.analisis.sentimiento}
                                            layout="vertical"
                                            margin={{
                                                top: 5,
                                                right: 30,
                                        ...
                                        >
                                            ...
                                            <Tooltip />
                                            <Legend />
                                            <Bar dataKey="positivo" name="Positivo" fill="#4ade80" stackId="a" />
                                            <Bar dataKey="neutral" name="Neutral" fill="#facc15" stackId="a" />
                                            <Bar dataKey="negativo" name="Negativo" fill="#f87171" stackId="a" />
                                        </BarChart>
                                    </ResponsiveContainer>
                                </div>
                        ...
                        <div className="mt-6 bg-gray-50 rounded-lg p-4 shadow-sm">
                            ...
                            <div className="h-72">
                                <ResponsiveContainer width="100%" height="100%">
                                    <RadarChart outerRadius={90} data={selectedMedio.analisis.comparativaCompetencia}>
                                        <PolarGrid />
                            ...
                            <div className="mt-2 flex justify-center">
                                <span className="text-xs text-gray-600">
                                    Comparativa de distribución temática entre los principales medios
                                </span>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <div className="h-52">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <ComposedChart
                                                data={selectedMedio.predicciones.proximosTemas}
                                                margin={{
                                                    top: 5,
                                                    right: 30,
                                                    left: 20,
                                ...
                                <div className="flex flex-col justify-center">
                                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            El sistema predice con un <span className="font-bold">85% de probabilidad</span> que
                                            en los próximos 15 minutos el programa tratará el tema del debate parlamentario,
                                            según los patrones históricos, la agenda del día y las menciones previas.
                                        </p>
